...
update-updateButton =
    .label = Restart to Update LunarFox
    .accesskey = R
...
update-noUpdatesFound = LunarFox is up to date
aboutdialog-update-checking-failed = Failed to check for updates.
update-otherInstanceHandlingUpdates = LunarFox is being updated by another instance
